...
public class SQLQueries {
    ...
    public static final String LOGIN_USER_QUERY = "select role from user where username = ? and password = ? and isregistered = 1";
    ...
    public static final String APPROVE_USER_QUERY = "update user set isregistered = 1 where userid = ?";
}
